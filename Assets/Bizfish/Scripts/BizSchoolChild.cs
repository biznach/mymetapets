...
public class BizSchoolChild:MonoBehaviour{
	...
	GameObject _object;				//Game object for components
	...
	public void SkewModelForLessUniformedMovement() {
        ...
        // Biz Correct NFT rotation offset
		//rx.eulerAngles = new Vector3(0.0f, -225.0f , 0.0f);
		//_model. rotation	 =	rx;
	}
	...
	public void RandomizeStartAnimationFrame(){
        ...
        //var anim = _object.GetComponent<Animation>();
        //var animList = _object.GetComponent<AnimationList>();
