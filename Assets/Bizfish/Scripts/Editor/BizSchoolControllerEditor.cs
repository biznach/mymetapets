...
*****************************************/
[CustomEditor(typeof(BizSchoolController))]
[System.Serializable]
public class BizSchoolControllerEditor: Editor
{
	...
	{
		var target_cs = (BizSchoolController)target;
	...
	public override void OnInspectorGUI()
	{
		...
		target_cs._childAmount = (int)EditorGUILayout.Slider("Fish Amount", (float)target_cs._childAmount, 0.0f, 500.0f);
