...
public class BizSchoolController:MonoBehaviour{
	...
	public int _childAmount = 1;				// Number of objects
	...
	public void Start() {
		...
		if (importGltf) {
			...
			importOptions.AutoScaleSize = 0.5f;
	...
	public void Update() {
		...
		//BIZ MOVED UPDATE OUT OF CONDITIONAL
		UpdateFishAmount();
		//BIZ IMPORTER
	...
	public void SetFishAmount(int fishCount)
	{
		_childAmount = fishCount;
	}
	...
	/// </param>
	private void OnImportComplete(GameObject importedModel)
	{
